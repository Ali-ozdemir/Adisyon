          ...
          if($stmt->rowCount() === 1){
            if($row = $stmt->fetch()){
              ...
              if(password_verify($password, $hashed_password)){
                ...
                header('location: masadurum.php');
              } else {
                // Display wrong password message
                $password_err = 'paralo yanlış';
              }
            }
          } else {
            $email_err = 'Mail Yanlış';
          }
        } else {
    ...
    <div class="row">
      <div class="col-md-6 mx-auto">
        <div class="card card-body bg-light mt-5">
          <h2>Login</h2>
          <p>Kimlik bilgilerinizi doldurun</p>
          <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">   
            ...
            <div class="form-row">
              ...
              <div class="col">
                <a href="register.php" class="btn btn-light btn-block">Kayıt Ol ... </a>
              </div>
            </div>
          </form>
        </div>
